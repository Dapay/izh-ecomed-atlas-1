...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [5882039.776302, 7697159.019105, 5972237.852409, 7751912.491951], maxZoom: 28, minZoom: 1
    })
});
...
map.getView().fit([5882039.776302, 7697159.019105, 5972237.852409, 7751912.491951], map.getSize());
