...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [5831742.196437, 7672584.094178, 6012138.348650, 7782091.039870], maxZoom: 28, minZoom: 1
    })
});
...
map.getView().fit([5831742.196437, 7672584.094178, 6012138.348650, 7782091.039870], map.getSize());
