...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [5838088.468259, 7679605.501300, 6018484.620472, 7789112.446992], maxZoom: 28, minZoom: 1
    })
});
...
map.getView().fit([5838088.468259, 7679605.501300, 6018484.620472, 7789112.446992], map.getSize());
