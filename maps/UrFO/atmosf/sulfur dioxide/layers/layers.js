...
var lyr__0 = new ol.layer.Vector({
                ...
                style: style__0,
                interactive: true,
    title: 'Средние значения концентраций диоксида серы, доли ПДК<br />\
    <img src="styles/legend/_0_0.png" /> менее 0.1<br />\
    <img src="styles/legend/_0_1.png" /> 0.1 - 0.5<br />\
    <img src="styles/legend/_0_2.png" /> 0.5 - 1<br />\
    <img src="styles/legend/_0_3.png" /> 1 - 5<br />\
    <img src="styles/legend/_0_4.png" /> 5 и более<br />'
        });
...
lyr__0.set('fieldAliases', {'index': 'index', 'SO2_min': 'SO2_min', 'SO2_max': 'SO2_max', 'label': 'label', });
...
lyr__0.set('fieldImages', {'index': 'TextEdit', 'SO2_min': 'TextEdit', 'SO2_max': 'TextEdit', 'label': 'TextEdit', });
...
lyr__0.set('fieldLabels', {'index': 'no label', 'SO2_min': 'no label', 'SO2_max': 'no label', 'label': 'no label', });
