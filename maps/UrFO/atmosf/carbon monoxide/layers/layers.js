...
var lyr__0 = new ol.layer.Vector({
                ...
                style: style__0,
                interactive: false,
    title: 'Средние значения концентраций оксида углерода, доли ПДК<br />\
    <img src="styles/legend/_0_0.png" /> менее 0.03<br />\
    <img src="styles/legend/_0_1.png" /> 0.03 - 0.1<br />\
    <img src="styles/legend/_0_2.png" /> 0.1 - 3<br />\
    <img src="styles/legend/_0_3.png" /> 3 - 13<br />\
    <img src="styles/legend/_0_4.png" /> 13 и более<br />'
        });
...
lyr__0.set('fieldAliases', {'index': 'index', 'CO2_min': 'CO2_min', 'CO2_max': 'CO2_max', 'label': 'label', });
...
lyr__0.set('fieldImages', {'index': 'Range', 'CO2_min': 'TextEdit', 'CO2_max': 'TextEdit', 'label': 'TextEdit', });
...
lyr__0.set('fieldLabels', {'index': 'no label', 'CO2_min': 'no label', 'CO2_max': 'no label', 'label': 'no label', });
